          ...
          <>
            ...
            <ListItemLink
              ...
              <ListItemLink
                ...
                icon={<TbMessageCircleBolt style={{ height: "25px", width: "25px", color: "#0073b7"}} />}
              />
              {showKanban && (
                <ListItemLink
                  to="/kanban"
                  primary="Kanban"
                  icon={<TbChartTreemap style={{ height: "25px", width: "25px", color: "#0073b7"}} />}
                />
              )}
              <ListItemLink
                to="/todolist"
              ...
              {showSchedules && (
                <>
                  <ListItemLink
                    ...
                    icon={<TbClockEdit style={{ height: "25px", width: "25px", color: "#0073b7"}} />}
                  />
                </>
              )}
              <ListItemLink
                ...
                icon={<LocalOfferIcon style={{ height: "25px", width: "25px", color: "#0073b7"}}/>}
              />
              {showInternalChat && (
                <>
                  <ListItemLink
                    ...
                    icon={<TbMessageChatbot style={{ height: "25px", width: "25px", color: "#0073b7"}} />}
                  />
                </>
              )}
              <ListItemLink
